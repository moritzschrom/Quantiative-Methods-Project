...
Mit Hilfe der `Zodiac()` Funktion aus dem `DescTools` Paket wird der Datumswert in das Sternzeichen (in Form einer Zeichenkette) umgewandelt.
...
Es handelt sich um fünf Merkmale, die pro Respondent:in erhoben wurden. `Sternzeichen` stellt ein Gruppierungsmekrmal dar, es handelt sich daher bei der Fragestellung, ob Charaktereigenschaften bei unterschiedlichen Sternzeichen gleich verteilt sind um ein *Homogenitätsproblem*.
...
Die relativen Anteile werden in Zeilenprozent, also normiet auf die Sternzeichen, angegeben:
...
Es ist zu erkennen, dass Charaktereigenschaften in der Stichprobe bei unterschidlichen Sternzeichen unterschiedlich häufig auftreten. So gibt es in der Stichprobe kaum Personen mit Sternzeichen Löwe und Charaktereigenschaft Introversion, jedoch viele Personen mit Sternzeichen Stier und Charaktereigenschaft Introversion.

Die relativen Häufigkeiten werden mit Hilfe eines Spineplots visualisiert:
